    ...
    if (submitted) {
        return (
            ...
            >
                ...
                <p className="text-gray-400">Hemos recibido su información y prueba de fondos correctamente. Nuestro equipo analizará su perfil y le contactará en breve.</p>
                <button
