...
function App() {
  const [activeTab, setActiveTab] = useState('hoteles'); // Default to first category
              ...
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  <div className="p-8 rounded-2xl bg-midnight-800 border border-white/5">
                    ...
                    <p className="text-gray-400">Auditoría legal completa (Due Diligence) disponible para cada activo de la cartera.</p>
                  </div>
                  <div className="p-8 rounded-2xl bg-midnight-800 border border-white/5">
                    <TrendingUp className="h-10 w-10 text-gold-500 mb-6" />
                    <h3 className="text-xl font-serif text-white mb-3">Alta Rentabilidad</h3>
                    <p className="text-gray-400">Seleccionamos activos con potencial de revalorización y yield superior a la media del mercado.</p>
                  </div>
                  <div className="p-8 rounded-2xl bg-midnight-800 border border-white/5">
                    <Handshake className="h-10 w-10 text-gold-500 mb-6" />
                    <h3 className="text-xl font-serif text-white mb-3">Trato Directo</h3>
                    <p className="text-gray-400">Gestión personal con propietarios y mandato directo, sin cadenas de intermediarios.</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                <div>
                  ...
                  <div className="space-y-6 text-lg text-gray-400">
                    <p>
                      Debido a la naturaleza confidencial de nuestros activos {activeTab === 'offmarket' ? 'off-market' : ''}, así como a la exclusividad de nuestros mandatos de venta, requerimos un proceso de verificación previo.
                    </p>
                    ...
                    <p className="flex items-start gap-3">
                      <ChevronRight className="flex-shrink-0 text-gold-500 mt-1" />
                      <span>Es <strong>imprescindible</strong> aportar una Prueba de Fondos (POF) o Carta de Intención Bancaria por el valor del activo de interés.</span>
                    </p>
                    <p className="flex items-start gap-3">
                      <ChevronRight className="flex-shrink-0 text-gold-500 mt-1" />
                  ...
                  <div className="mt-12 p-6 bg-gold-900/10 border border-gold-500/20 rounded-xl">
                    <h4 className="text-gold-400 font-bold mb-2">Nota Importante</h4>
